...
# +10degC Dark Frames
subfolder = "3.1_p10_DARK_1minexpo"
filenames = ['3.1_p10.00000017.DARK.FIT',  '3.1_p10.00000022.DARK.FIT',
             '3.1_p10.00000018.DARK.FIT',  '3.1_p10.00000023.DARK.FIT',
             '3.1_p10.00000019.DARK.FIT',  '3.1_p10.00000024.DARK.FIT',
             '3.1_p10.00000020.DARK.FIT',  '3.1_p10.00000025.DARK.FIT',
             '3.1_p10.00000021.DARK.FIT',  '3.1_p10.00000026.DARK.FIT' ]

# +10degC Darks with Varying Exposure
subfolder2 = "3.1_p10_DARK_varyexpo"
filenames2 =  ['3.1_p10.00000010.DARK.FIT',  '3.1_p10.00000011.DARK.FIT',
               '3.1_p10.00000012.DARK.FIT',  '3.1_p10.00000013.DARK.FIT',
               '3.1_p10.00000014.DARK.FIT',  '3.1_p10.00000015.DARK.FIT',
               '3.1_p10.00000016.DARK.FIT' ]

fig1 = '4.2.1_p10_DARK_hist.png'
title1 = r'Dark Frames with 1min Exopsure at $+10^{\circ}C$'

fig2 = '4.2.1_p10_darkcurrenttest.png'
title2 = r'Dark Current Image Test'

fig3 = '4.2.1_p10_countsvsexpo.png'
title3 = r'Typical Counts vs Exposure Time ($+10^{\circ}C$)'

masterbias_name = 'p10_masterbias.npy'
...
# initialize array to hold mode of each image
darkcurrent_mode = []
darkcurrent_sig = []
...
for dark in allimages:
    ...
    # using std for now, probably wrong
    #darkcurrent_sig.append(np.std(darkcurrent_val))
